...
\index{Parallel@{Parallel}!create\+Geometry@{create\+Geometry}}
\index{create\+Geometry@{create\+Geometry}!Parallel@{Parallel}}
\subsubsection[{\texorpdfstring{create\+Geometry(std\+::array$<$ int, 4 $>$ lattice\+Size, std\+::array$<$ int, 4 $>$ sub\+Lattice\+Size)}{createGeometry(std::array< int, 4 > latticeSize, std::array< int, 4 > subLatticeSize)}}]{\setlength{\rightskip}{0pt plus 5cm}void Parallel\+::create\+Geometry (
\begin{DoxyParamCaption}
\item[{std\+::array$<$ int, 4 $>$}]{lattice\+Size, }
\item[{std\+::array$<$ int, 4 $>$}]{sub\+Lattice\+Size}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{classParallel_a8888fe404de3a3f479fff0796916f851}{}\label{classParallel_a8888fe404de3a3f479fff0796916f851}
...
{\em lattice\+Size} & array containing the total size of the lattice \\
\hline
{\em lattice\+Size} & array containing the size of each sublattice \\
\hline
\end{DoxyParams}
...
\hyperlink{parallel_8cpp}{parallel.\+cpp}\end{DoxyCompactItemize}
